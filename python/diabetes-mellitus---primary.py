...
codes = [{"code":"C10..00","system":"readv2"},{"code":"C108.12","system":"readv2"},{"code":"C108.13","system":"readv2"},{"code":"C109.12","system":"readv2"},{"code":"C109.13","system":"readv2"},{"code":"C10E.00","system":"readv2"},{"code":"C10E.11","system":"readv2"},{"code":"C10F.00","system":"readv2"},{"code":"C10F.11","system":"readv2"},{"code":"C10FS00","system":"readv2"},{"code":"Cyu2.00","system":"readv2"},{"code":"K01x100","system":"readv2"},{"code":"Kyu0300","system":"readv2"},{"code":"250 E","system":"oxmis"}];
REQUIRED_CODES = 1;
