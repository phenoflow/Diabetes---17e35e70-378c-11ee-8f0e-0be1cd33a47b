...
steps:
  ...
  diabetes-admission---primary:
    run: diabetes-admission---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-related---primary:
    run: diabetes-related---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  maculopathy-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-related---primary/output
  ...
  diabetes-followup---primary:
    run: diabetes-followup---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  moderate-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-followup---primary/output
  ...
  diabetes-monitoring---primary:
    run: diabetes-monitoring---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-assessment---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-monitoring---primary/output
  ...
  diabetes-hypoglycaemia---primary:
    run: diabetes-hypoglycaemia---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  under-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-hypoglycaemia---primary/output
  ...
  diabetes-given---primary:
    run: diabetes-given---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  hospital-diabetes---primary:
    run: hospital-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-diabetology---primary:
    run: diabetes-diabetology---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-compliance---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-diabetology---primary/output
  ...
  diabetes-excretion---primary:
    run: diabetes-excretion---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-screener---primary:
    run: diabetes-screener---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-refer---primary/output
  diabetes-register---primary:
    run: diabetes-register---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  advanced-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-register---primary/output
  ...
  multidisciplinary-diabetes---primary:
    run: multidisciplinary-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  clinic-diabetes---primary:
    run: clinic-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-community---primary:
    run: diabetes-community---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: clinic-diabetes---primary/output
  diabetes-liaison---primary:
    run: diabetes-liaison---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-liaison---primary/output
  ...
  diabetes-albumin---primary:
    run: diabetes-albumin---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  exudative-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-albumin---primary/output
